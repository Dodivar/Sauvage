...
<template>
  ...
  >
    ...
    >
      ...
      >
      <RouterLink to="/collection" @click="closeMobileMenu" class="hover:text-primary transition-colors"
      ...
      <div class="grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul class="space-y-2">
            ...
            <li>
              <RouterLink to="/collection" class="text-gray-300 hover:text-primary transition-colors"
                >Nos montres</RouterLink
              >
            </li>
            <li>
              <RouterLink to="/depot-vente" class="text-gray-300 hover:text-primary transition-colors"
                >Dépôt-vente</RouterLink
              >
            </li>
            <li>
              <RouterLink to="/#faq" class="text-gray-300 hover:text-primary transition-colors">FAQ</RouterLink>
            </li>
            <li>
