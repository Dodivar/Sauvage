<template>
  <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
    ...
    <div class="relative h-80 bg-gray-100">
      <div class="absolute inset-0 flex items-center justify-center" v-if="watch.images.length === 0">
    ...
    <!-- Watch Info -->
    <div class="p-6">
      <h3 class="text-xl font-serif font-semibold text-gray-900 mb-2 leading-tight">
        {{ watch.name }}
      </h3>
