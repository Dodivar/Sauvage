    ...
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="space-y-8">
          ...
          <div class="bg-white rounded-xl shadow-lg p-6">
            ...
            <div class="flex flex-col sm:flex-row gap-4">
              <a
                :href="'https://wa.me/' + whatsapp + '?text=' + encodeURIComponent(`Bonjour, je suis intéressé par la montre ${watch.name} (Réf. ${watch.reference}) au prix de ${formatPrice(watch.price)}`)"
                target="_blank"
      ...
      <div class="grid lg:grid-cols-2 gap-8 mb-12">
        ...
        <div class="bg-white rounded-xl shadow-lg p-6">
          ...
          <div class="space-y-3">
            <div v-for="(item, index) in watch.details.accessories" :key="index" class="flex items-center space-x-3">
              <svg 
                :class="[
                  'w-5 h-5',
